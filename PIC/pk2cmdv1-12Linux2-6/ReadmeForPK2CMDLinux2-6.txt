...
----------------------------------------------------------------------------
The pk2cmd binary for kernel 2.6 was built on CentOS 4.5 (RHEL 4.5). It has
...
Use -S with a string parameter, so execute the operations
